...
public class Storage {
    ...
    static func store<T: Encodable>(_ obj: T, to directory: Directory, as fileName: String) {
        ...
        let encoder = JSONEncoder() // encoder 호출
    ...
    static func remove(_ fileName: String, form directory: Directory) {
        let url = directory.url.appendingPathComponent(fileName, isDirectory: false)
    ...
    static func clear(_ directory: Directory) {
        ...
        do {
            ...
            print("---> Failed to clear dirctory msg: \(error.localizedDescription)")
        }
    }
}
...
extension Storage {
    static func saveTodo(_ obj: Todo, fileName: String){
        let url = Directory.documets.url.appendingPathComponent(fileName, isDirectory: false)
